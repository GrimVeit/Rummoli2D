...
public class MoveEffect_IntroPlayingFields : MoveEffect
{
    ...
    [SerializeField] private float timeMoveFromDownToNormal;
    ...
    public override void DeactivateEffect(Action OnComplete = null)
    {
        ...
        //Down
        seq.Append(moveElement.DOLocalMove(transformDown.localPosition, timeMoveFromDownToNormal).SetEase(Ease.InCubic));

        //Up
        seq.Append(moveElement.DOLocalMove(transformUp.localPosition, timeMoveFromUpToDown).SetEase(Ease.OutCubic));
    }
}
